...
function checkResultAndHandleErrors(result, info, responseKey) {
    ...
    if (result.errors && (!result.data || result.data[responseKey] == null)) {
        var errorMessage = result.errors
            ...
            .join('\n');
        var combinedError = new CombinedError(errorMessage, result.errors);
        throw error_1.locatedError(combinedError, info.fieldNodes, graphql_1.responsePathAsArray(info.path));
    }
    else {
